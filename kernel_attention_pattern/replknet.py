...
sys.path.append('/cutlass/examples/19_large_depthwise_conv2d_torch_extension')
...
class RepLKNet(nn.Module):
    ...
    def __init__(self, large_kernel_sizes, layers, channels, drop_path_rate, small_kernel,
                 dw_ratio=1, ffn_ratio=4, in_channels=3, num_classes=1000, out_indices=None, pretrained=False,
...
@register_model
def replknet_base(drop_path_rate=0.3, num_classes=1000, use_checkpoint=False, small_kernel_merged=False, **kwargs):
    return RepLKNet(large_kernel_sizes=[31,29,27,13], layers=[2,2,18,2], channels=[128,256,512,1024],
                    ...
                    small_kernel_merged=small_kernel_merged, **kwargs)

@register_model
def replknet_large(drop_path_rate=0.3, num_classes=1000, use_checkpoint=False, small_kernel_merged=False):
    return RepLKNet(large_kernel_sizes=[31,29,27,13], layers=[2,2,18,2], channels=[192,384,768,1536],
                    drop_path_rate=drop_path_rate, small_kernel=5, num_classes=num_classes, use_checkpoint=use_checkpoint,
                    small_kernel_merged=small_kernel_merged)

@register_model
def replknet_XL(drop_path_rate=0.3, num_classes=1000, use_checkpoint=True, small_kernel_merged=False):
